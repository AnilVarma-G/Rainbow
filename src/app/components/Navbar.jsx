...
<Link href="/" className="flex items-center text-[15px] md:text-3xl overflow-y-hidden text-white font-semibold overflow-x-hidden">
  <span style={{
  ...
  <span className="text-blue-900 ml-2 " style={{ fontFamily: 'Times New Roman',}}>CONCEPT</span>
             <span className="text-blue-900 ml-2  " style={{ fontFamily: 'Times New Roman',}}>SCHOOL</span>
</Link>
