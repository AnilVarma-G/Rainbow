...
const NavLink = ({ href, title, onClick }) => {
  ...
  return (
    <Link href={href} passHref>
      <span onClick={handleClick} className={`block py-2 pl-3 pr-4 text-blue-900  hover:text-red-700 sm:text-xl rounded md:p-0 nav-link ${styles.navLink} ${styles.rainbowText}`}>
        {title}
      </span>
    </Link>
  );
