  ...
  />
      ...
      {images.map((elem, idx) => (
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center font-semibold text-pink-600 px-6">
            <motion.div
              initial={{
                opacity: idx === activeImage ? 0 : 0.5,
                scale: idx === activeImage ? 0.5 : 0.3,
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2 left-4 z-50 flex justify-start items-center">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5 }}
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2 right-4 z-50 flex justify-end items-center">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.5 }}
